...
f = open('mycode/val_split_ship_imgList.txt', 'r')
lines = f.readlines()
f.close()

num_ships_all = 0
orig_annot_path = '../DOTA/val_split/labelTxt/'
target_annot_path = '../DOTA/val_split/ship_label/'
img_path = '../DOTA/val_split/images/'
